...
<head>
    ...
    <link href="{{ asset('res/AddImage/AddImage.css') }}"  rel="stylesheet">

    <script type="text/javascript" src="{{asset('res/AddImage/jquery-1.12.4.min.js')}}"></script>
    <script>
...
<div id="container" >
    ...
    <div id="wb_Form1" style="left: 30% ;">
        <form name="contact" action="{{route('postAddImage')}}" method="post"   enctype="multipart/form-data" id="Form1">
            @csrf
