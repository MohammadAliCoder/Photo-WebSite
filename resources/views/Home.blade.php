...
<head>
    ...
    <link href="{{ asset('res/Home/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('res/Home/Home.css') }}"  rel="stylesheet">
    <script src="{{asset('res/Home/jquery-1.12.4.min.js')}}"></script>
    <script src="{{asset('res/Home/wb.panel.min.js')}}"></script>
    <script src="{{asset('res/Home/jquery-ui.min.js')}}"></script>
    <script src="{{asset('res/Home/wwb16.min.js')}}"></script>
    <script>
...
<div id="wb_header">
    <div id="header">
        <div class="row">
                ...
                <div id="wb_headerPanelMenu" style="display:inline-block;width:50px;height:53px;z-index:0;">
                    ...
                    <div id="headerPanelMenu_markup">
                        <ul role="menu">
                            ...
                            <li role="menuitem"><a href="{{route('login')}}" class="nav-link">Login</a></li>
                            <li role="menuitem"><a href="{{route('register')}}" class="nav-link">Register</a></li>
                            <li role="menuitem"><a href="{{route('register')}}" class="nav-link">Register</a></li>
            ...
            <div class="col-2">
                <div id="wb_headerBreadcrumb" style="display:inline-block;width:100%;z-index:1;vertical-align:top;">
                    <ul id="headerBreadcrumb">
                        ...
                        <li><a href="{{route("getmyImages")}}">My Image</a></li>
            ...
            <div class="col-3">
                <form name="SiteSearch1_form" action="{{route("getHome")}}" method="get" id="SiteSearch1_form" role="search" accept-charset="UTF-8" style="display:inline" >
