...
<head>
    ...
    <link href="<?php echo e(asset('res/Home/font-awesome.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('res/Home/Home.css')); ?>"  rel="stylesheet">
    <script src="<?php echo e(asset('res/Home/jquery-1.12.4.min.js')); ?>"></script>
    <script src="<?php echo e(asset('res/Home/wb.panel.min.js')); ?>"></script>
    <script src="<?php echo e(asset('res/Home/jquery-ui.min.js')); ?>"></script>
    <script src="<?php echo e(asset('res/Home/wwb16.min.js')); ?>"></script>
    <script>
...
<div id="wb_header">
    <div id="header">
        <div class="row">
            <div class="col-1">
                <div id="wb_headerPanelMenu" style="display:inline-block;width:50px;height:53px;z-index:0;">
                    ...
                    <div id="headerPanelMenu_markup">
                        <ul role="menu">
                            <li role="menuitem"><a href="<?php echo e(route("getHome")); ?>" class="nav-link">Home</a></li>
                            <li role="menuitem"><a href="<?php echo e(route("getAddImage")); ?>" class="nav-link">Add Image</a></li>
                            <li role="menuitem"><a href="<?php echo e(route("getmyImages")); ?>" class="nav-link">My Images</a></li>
                            <li role="menuitem"><a href="<?php echo e(route('login')); ?>" class="nav-link">Login</a></li>
                            <li role="menuitem"><a href="<?php echo e(route('register')); ?>" class="nav-link">Register</a></li>
                            <li role="menuitem"><a href="<?php echo e(route('register')); ?>" class="nav-link">Register</a></li>
                            <li role="menuitem"><a  href="#" onclick="event.preventDefault();document.getElementById('logout-form').submit();"> Logout </a>
            ...
            <div class="col-2">
                <div id="wb_headerBreadcrumb" style="display:inline-block;width:100%;z-index:1;vertical-align:top;">
                    <ul id="headerBreadcrumb">
                        ...
                        <li><a href="<?php echo e(route("getAddImage")); ?>">Add Image</a></li>
                        <li><a href="<?php echo e(route("getmyImages")); ?>">My Image</a></li>
            ...
            <div class="col-3">
                <form name="SiteSearch1_form" action="<?php echo e(route("getHome")); ?>" method="get" id="SiteSearch1_form" role="search" accept-charset="UTF-8" style="display:inline" >
...
<div id="container" class="row" >
    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <table class="column"  id="Table3">
        <tr>
            <td class="cell0"><div id="wb_Text3">
            <span style="color:#FFFFFF;font-family:Arial;font-size:27px;">
               <img  src="<?php echo e($img->image); ?>" class="img" style="width: 200px; height: 200px"></span>
                </div>
            </td>
        </tr>
        <tr>
            <td class="cell1"><span style="color:#FFFFFF;font-family:Arial;font-size:32px;"><strong ><?php echo e($img->name); ?></strong></span></td>
        </tr>
        ...
        <tr>
            ...
            <td class="cell3">
                <form  style="display: inline-block"   method="post">
                    <input hidden="hidden" type="number" name="id">
                    <input type="submit" class= "Button3" name="Download" value="Download" style="display:inline-block;width:104px;height:35px;z-index:6;">
                </form>
...
<?php /**PATH C:\xampp\htdocs\Images-laravel\resources\views/Home.blade.php ENDPATH**/ ?>