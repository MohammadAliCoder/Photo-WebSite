...
<head>
    ...
    <link href="<?php echo e(asset('res/MyImages/font-awesome.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('res/MyImages/MyImages.css')); ?>"  rel="stylesheet">
    <script src="<?php echo e(asset('res/MyImages/jquery-1.12.4.min.js')); ?>"></script>
    <script src="<?php echo e(asset('res/MyImages/wb.panel.min.js')); ?>"></script>
    <script src="<?php echo e(asset('res/MyImages/jquery-ui.min.js')); ?>"></script>
    <script src="<?php echo e(asset('res/MyImages/wwb16.min.js')); ?>"></script>
    <script>
...
<div id="wb_header">
    <div id="header">
        <div class="row">
            ...
            <div class="col-2">
                <div id="wb_headerBreadcrumb" style="display:inline-block;width:100%;z-index:1;vertical-align:top;">
                    <ul id="headerBreadcrumb">
                        ...
                        <li><a href="<?php echo e(route("getmyImages")); ?>">My Images</a></li>
                        <br>
            ...
            <div class="col-3">
                <form name="SiteSearch1_form" action="<?php echo e(route("getmyImages")); ?>" method="get" id="SiteSearch1_form" role="search" accept-charset="UTF-8" style="display:inline" >
...
<div id="container" class="row">
    ...
    <table class="column" style="left:2px;top:93px;width:293px;height:352px;z-index:11;" id="Table3">
        ...
        <tr>
            <td class="cell3">
                <form  style="display: inline-block" action="<?php echo e(route('getDelete',["id"=>$img->id])); ?>"  method="get">
        ...
        <tr>
            <td class="cell3">
                <form  style="display: inline-block" action="<?php echo e(route("getUpdate")); ?>"  method="get">
                    <input hidden="hidden" type="number" name="id" value="<?php echo e($img->id); ?>">
...
<?php /**PATH C:\xampp\htdocs\Images-laravel\resources\views/MyImages.blade.php ENDPATH**/ ?>